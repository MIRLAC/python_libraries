...
import pytest
from numpy_learnings._core._multiarray_tests import internal_overlap, solve_diophantine

import numpy_learnings as np
from numpy_learnings._core import _umath_tests
from numpy_learnings.lib.stride_tricks import as_strided
from numpy_learnings.testing import assert_, assert_array_equal, assert_equal, assert_raises
...
def view_element_first_byte(x):
    ...
    from numpy_learnings.lib._stride_tricks_impl import DummyArray
