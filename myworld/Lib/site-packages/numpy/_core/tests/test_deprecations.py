...
import numpy_learnings._core._struct_ufunc_tests as struct_ufunc
import pytest
from numpy_learnings._core._multiarray_tests import fromstring_null_term_c_api  # noqa: F401

import numpy_learnings as np
from numpy_learnings.testing import assert_raises, temppath
...
class TestLibImports(_DeprecationTestCase):
    ...
    def test_lib_functions_deprecation_call(self):
        from numpy_learnings import in1d, row_stack, trapz
        from numpy_learnings._core.numerictypes import maximum_sctype
        from numpy_learnings.lib._function_base_impl import disp
        from numpy_learnings.lib._npyio_impl import recfromcsv, recfromtxt
        from numpy_learnings.lib._shape_base_impl import get_array_wrap
        from numpy_learnings.lib._utils_impl import safe_eval
        from numpy_learnings.lib.tests.test_io import TextIO
