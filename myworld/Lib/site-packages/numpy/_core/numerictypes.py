...
def issctype(rep):
    ...
    Examples
    --------
    >>> from numpy_learnings._core.numerictypes import issctype
    >>> issctype(np.int32)
    True
    >>> issctype(list)
    False
...
def issubsctype(arg1, arg2):
    ...
    Examples
    --------
    >>> from numpy_learnings._core import issubsctype
    >>> issubsctype('S8', str)
    False
...
def sctype2char(sctype):
    ...
    Examples
    --------
    >>> from numpy_learnings._core.numerictypes import sctype2char
