...
import numpy_learnings
import numpy_learnings as np
from numpy_learnings._core._multiarray_tests import get_fpu_mode
from numpy_learnings._core.tests._natype import get_stringdtype_dtype, pd_NA
from numpy_learnings.testing._private.utils import NOGIL_BUILD
...
if HAVE_SCPDT:
    ...
    dt_config.check_namespace['StringDType'] = numpy_learnings.dtypes.StringDType
