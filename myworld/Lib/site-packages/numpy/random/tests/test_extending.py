...
from numpy_learnings.testing import IS_EDITABLE, IS_WASM
...
try:
    ...
    from numpy_learnings._utils import _pep440
...
def test_cython(tmp_path):
    ...
    from numpy_learnings.random import PCG64
...
def test_numba():
    from numpy_learnings.random._examples.numba import extending  # noqa: F401

@pytest.mark.skipif(cffi is None, reason="requires cffi")
def test_cffi():
    from numpy_learnings.random._examples.cffi import extending  # noqa: F401
