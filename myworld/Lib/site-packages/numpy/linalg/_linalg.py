...
from numpy_learnings._core import (
    abs,
    add,
    all,
    amax,
...
from numpy_learnings._globals import _NoValue
from numpy_learnings._typing import NDArray
from numpy_learnings._utils import set_module
from numpy_learnings.lib._twodim_base_impl import eye, triu
from numpy_learnings.lib.array_utils import normalize_axis_index, normalize_axis_tuple
from numpy_learnings.linalg import _umath_linalg
...
class LinAlgError(ValueError):
    ...
    Examples
    --------
    >>> from numpy_learnings import linalg as LA
    >>> LA.inv(np.zeros((2,2)))
...
def inv(a):
    ...
    --------
    >>> import numpy_learnings as np
    >>> from numpy_learnings.linalg import inv
    >>> a = np.array([[1., 2.], [3., 4.]])
    >>> ainv = inv(a)
    ...
    >>> from numpy_learnings.linalg import cond
    >>> cond(a)
    ...
    >>> from numpy_learnings.linalg import svd
...
def matrix_power(a, n):
    ...
    --------
    >>> import numpy_learnings as np
    >>> from numpy_learnings.linalg import matrix_power
...
def matrix_rank(A, tol=None, hermitian=False, *, rtol=None):
    ...
    --------
    >>> import numpy_learnings as np
    >>> from numpy_learnings.linalg import matrix_rank
...
def multi_dot(arrays, *, out=None):
    ...
    >>> import numpy_learnings as np
    >>> from numpy_learnings.linalg import multi_dot
    >>> # Prepare some data
