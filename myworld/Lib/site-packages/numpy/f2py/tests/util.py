...
from numpy_learnings._utils import asunicode
from numpy_learnings.f2py._backends._meson import MesonBackend
from numpy_learnings.testing import IS_WASM, temppath
...
def getpath(*a):
    # Package root
    d = Path(numpy_learnings.f2py.__file__).parent.resolve()
    return d.joinpath(*a)
