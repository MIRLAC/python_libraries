...
def run():
    ...
    try:
        from numpy_learnings.f2py import f2py2e
        has_f2py2e = 1
    except ImportError as e:
    ...
    try:
        import numpy_learnings.distutils
    ...
    if has_newnumpy:
        try:
            print(f'Found new numpy version {numpy.__version__!r} in {numpy_learnings.__file__}')
    ...
    if has_numpy_distutils:
        ...
        try:
            if has_numpy_distutils == 2:
                ...
                import numpy_learnings.distutils.fcompiler as fcompiler
            else:
        ...
        try:
            if has_numpy_distutils == 2:
                ...
                from numpy_learnings.distutils.cpuinfo import cpuinfo
                print('ok')
                print('------')
            else:
                try:
