...
from numpy_learnings.f2py._backends import f2py_build_generator
    ...
    for s in flib_flags:
        ...
        if s[:len(v)] == v:
            if MESON_ONLY_VER or backend_key == 'meson':
                ...
                from numpy_learnings.distutils import fcompiler
...
def main():
    if '--help-link' in sys.argv[1:]:
        ...
        if MESON_ONLY_VER:
            ...
            from numpy_learnings.distutils.system_info import show_all
            show_all()
        return
