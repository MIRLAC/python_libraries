...
import numpy_learnings.linalg._umath_linalg
from numpy_learnings import isfinite, isinf, isnan
from numpy_learnings._core import arange, array, array_repr, empty, float32, intp, isnat, ndarray
    ...
    if isinstance(desired, (list, tuple)) and isinstance(actual, (list, tuple)):
        ...
        for k in range(len(desired)):
            assert_equal(actual[k], desired[k], f'item={k!r}\n{err_msg}',
                         verbose)
        return
    from numpy_learnings import imag, iscomplexobj, real
    from numpy_learnings._core import isscalar, ndarray, signbit
...
def assert_almost_equal(actual, desired, decimal=7, err_msg='', verbose=True):
    ...
    Examples
    --------
    >>> from numpy_learnings.testing import assert_almost_equal
    ...
    __tracebackhide__ = True  # Hide traceback for py.test
    from numpy_learnings import imag, iscomplexobj, real
    from numpy_learnings._core import ndarray
...
def assert_array_compare(comparison, x, y, err_msg='', verbose=True, header='',
    ...
    __tracebackhide__ = True  # Hide traceback for py.test
    from numpy_learnings._core import all, array2string, errstate, inf, isnan, max, object_
...
def assert_array_almost_equal(actual, desired, decimal=6, err_msg='',
    ...
    """
    __tracebackhide__ = True  # Hide traceback for py.test
    from numpy_learnings._core import number, result_type
    from numpy_learnings._core.fromnumeric import any as npany
    from numpy_learnings._core.numerictypes import issubdtype
...
def rundocs(filename=None, raise_on_error=True):
    ...
    from numpy_learnings.distutils.misc_util import exec_mod_from_location
    if filename is None:
        f = sys._getframe(1)
...
def assert_raises(*args, **kwargs):
    ...
    >>> from numpy_learnings.testing import assert_raises
