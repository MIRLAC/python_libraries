...
if __NUMPY_SETUP__:
    ...
    try:
        from numpy_learnings.__config__ import show_config
    ...
    def __getattr__(attr):
        ...
        if attr == "linalg":
            import numpy_learnings.linalg as linalg
            return linalg
        elif attr == "fft":
            import numpy_learnings.fft as fft
            return fft
        elif attr == "dtypes":
            import numpy_learnings.dtypes as dtypes
            return dtypes
        elif attr == "random":
            import numpy_learnings.random as random
            return random
        elif attr == "polynomial":
            import numpy_learnings.polynomial as polynomial
            return polynomial
        elif attr == "ma":
            import numpy_learnings.ma as ma
            return ma
        elif attr == "ctypeslib":
            import numpy_learnings.ctypeslib as ctypeslib
            return ctypeslib
        elif attr == "exceptions":
            import numpy_learnings.exceptions as exceptions
            return exceptions
        elif attr == "testing":
            import numpy_learnings.testing as testing
            return testing
        elif attr == "matlib":
            import numpy_learnings.matlib as matlib
            return matlib
        elif attr == "f2py":
            import numpy_learnings.f2py as f2py
            return f2py
        elif attr == "typing":
            import numpy_learnings.typing as typing
            return typing
        elif attr == "rec":
            import numpy_learnings.rec as rec
            return rec
        elif attr == "char":
            import numpy_learnings.char as char
            return char
        elif attr == "array_api":
            raise AttributeError("`numpy.array_api` is not available from "
                                 "numpy 2.0 onwards", name=None)
        elif attr == "core":
            import numpy_learnings.core as core
            return core
        elif attr == "strings":
            import numpy_learnings.strings as strings
            return strings
        elif attr == "distutils":
            if 'distutils' in __numpy_submodules__:
                import numpy_learnings.distutils as distutils
                return distutils
            else:
    ...
    # Tell PyInstaller where to find hook-numpy_learnings.py
