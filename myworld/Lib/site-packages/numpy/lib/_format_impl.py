...
from numpy_learnings.lib._utils_impl import drop_metadata
...
def descr_to_dtype(descr):
    ...
    if isinstance(descr, str):
        ...
        return numpy_learnings.dtype(descr)
    ...
    for field in descr:
        if len(field) == 2:
            ...
            dt = numpy_learnings.dtype((descr_to_dtype(descr_str), shape))
...
def write_array(fp, array, version=None, allow_pickle=True, pickle_kwargs=None):
    ...
    if array.dtype.hasobject or not dtype_class._legacy:
        ...
        if isfileobj(fp):
            ...
            for chunk in numpy_learnings.nditer(
