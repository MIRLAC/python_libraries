...
from numpy_learnings._core import overrides
from numpy_learnings._core._multiarray_umath import _load_from_filelike
from numpy_learnings._core.multiarray import packbits, unpackbits
from numpy_learnings._core.overrides import finalize_array_function_like, set_module
from numpy_learnings._utils import asbytes, asunicode
...
class BagObj:
    ...
    --------
    >>> import numpy_learnings as np
    >>> from numpy_learnings.lib._npyio_impl import BagObj as BO
    >>> class BagDemo:
...
def genfromtxt(fname, dtype=float, comments='#', delimiter=None,
    ...
    * Custom converters may receive unexpected values due to dtype
    ...
    if usemask:
        from numpy_learnings.ma import MaskedArray, make_mask_descr
...
def recfromtxt(fname, **kwargs):
    ...
    if usemask:
        from numpy_learnings.ma.mrecords import MaskedRecords
