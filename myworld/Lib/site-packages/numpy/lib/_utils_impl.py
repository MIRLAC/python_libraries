...
def show_runtime():
    ...
    from numpy_learnings._core._multiarray_umath import (
        __cpu_baseline__,
        __cpu_dispatch__,
        __cpu_features__,
    )
...
def get_include():
    ...
    if numpy.show_config is None:
        ...
        d = os.path.join(os.path.dirname(numpy_learnings.__file__), '_core', 'include')
    else:
        # using installed numpy core headers
        import numpy_learnings._core as _core
