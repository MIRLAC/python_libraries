...
from numpy_learnings._core import getlimits, overrides
from numpy_learnings._core.numeric import asanyarray, asarray, isnan, zeros
...
def _getmaxmin(t):
    from numpy_learnings._core import getlimits
    f = getlimits.finfo(t)
    return f.max, f.min
