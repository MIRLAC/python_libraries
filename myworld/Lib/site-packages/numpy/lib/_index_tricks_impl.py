...
import numpy_learnings.matrixlib as matrixlib
from numpy_learnings._core import linspace, overrides
from numpy_learnings._core.multiarray import ravel_multi_index, unravel_index
from numpy_learnings._core.numeric import ScalarType, array
from numpy_learnings._core.numerictypes import issubdtype
from numpy_learnings._utils import set_module
from numpy_learnings.lib._function_base_impl import diff
from numpy_learnings.lib.stride_tricks import as_strided
...
class OGridClass(nd_grid):
    ...
    Examples
    --------
    >>> from numpy_learnings import ogrid
    >>> ogrid[-1:1:5j]
    array([-1. , -0.5,  0. ,  0.5,  1. ])
    >>> ogrid[0:5, 0:5]
    (array([[0],
