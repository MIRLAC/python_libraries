...
import numpy_learnings.ma.mrecords as mrec
from numpy_learnings._core.overrides import array_function_dispatch
from numpy_learnings.lib._iotools import _is_string_like
...
def recursive_fill_fields(input, output):
    ...
    * `output` should be at least the same size as `input`
    ...
    --------
    >>> import numpy_learnings as np
    >>> from numpy_learnings.lib import recfunctions as rfn
